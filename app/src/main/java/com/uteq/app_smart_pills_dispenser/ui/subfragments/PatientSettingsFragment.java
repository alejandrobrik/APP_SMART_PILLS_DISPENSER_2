...
public class PatientSettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cardViewDevice = view.findViewById(R.id.menu_item_2_card_link_device);
        cardViewDevice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Bundle bundle = new Bundle();
                bundle.putSerializable("patient", patient);
                Navigation.findNavController(view).navigate(R.id.action_patientSettingsFragment2_to_diviceAddFragment, bundle);
            }
        });
